...
from bengalese_finch.models.ddHCRP_LM import *
from bengalese_finch.models import *
import _pickle as cPickle

def create_timestamped_dataframe():
    all_data, all_onsets, all_durations, all_latencies = utils.get_timestamped_data(phase='baseline')
    ...
    for subject in all_data.keys():
        ...
        durations = utils.flatten(all_durations[subject][:n_bouts])
        latencies = utils.flatten(all_latencies[subject][:n_bouts])
        bouts     = utils.flatten(all_data[subject][:n_bouts])
